...
<html>
    <head>
        ...
        <style>
            .banner-background{
                clip-path: polygon(30% 0%, 70% 0%, 100% 0, 100% 93%, 65% 100%, 33% 92%, 0 100%, 0 0);
            }
        </style>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#"><apan class="fa fa-bell-o"></apan>LearnCodeWith Me <span class="sr-only">(current)</span></a>
                    </li>
